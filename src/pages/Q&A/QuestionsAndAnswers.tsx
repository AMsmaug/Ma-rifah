    ...
    >
      <Stack spacing={2}>
        ...
        <Box className="answers" mt={1}>
          ...
          <Stack spacing={2} className="answers-wrapper" divider={<Divider />}>
            <Stack spacing={1}>
              <Stack spacing={1} direction="row" alignItems="center">
            ...
            <Stack spacing={1}>
              ...
              >
                <Typography variant="subtitle1" pl={2} flexBasis="80%">
                  Ohh that's a very good question. In the first part, you should
                  replace x with + infinity and you will get inifnity + 2 over 5
                  . Infinity over a constant is infinity. So the result is +
                  infinity. <br />
